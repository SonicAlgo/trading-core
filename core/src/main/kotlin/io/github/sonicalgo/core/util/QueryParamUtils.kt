 ...
 * where field names match query parameter names. Uses the shared
 * [HttpClient.objectMapper] from trading-core for consistent serialization.
 *
 * @param obj The object to convert
 * @return Map of query parameter names to values (null values are preserved for optional params)
 */
